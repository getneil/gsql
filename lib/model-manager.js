...
function ModelManager(gsqlObject){
...
ModelManager.prototype.register = function(modelName,configuration){
  return new Model(modelName,configuration,this.connection);
}
ModelManager.prototype.getSyncSequence = function(){
...
ModelManager.prototype.initializeDatabase = function(config){ // config maybe has initial seed data
  let mm = this;
